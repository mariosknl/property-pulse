...
Now we want to be able to send messages again. We will have an action for that. Create a new action at `app/actions/addMessage.js`:
...
Now let's use this action in the `PropertyContactForm` component.
